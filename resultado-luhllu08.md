...
|---------|-------|----------|---------|------------------|
| Atividade 2 - Enviar arquivo HTML | GET /index responde com status 200 | ✅ | ❌ | AssertionError: expected 500 to be 200 // Object.is equality |
...
| Atividade 4 - Três Rotas Diferentes | GET /two responde com o arquivo two.html | ✅ | ❌ | AssertionError: expected 500 to be 200 // Object.is equality |
